...
const Home = () => {
  const handleDownload = () => {
    window.open(
      "https://drive.google.com/file/d/1X-ygQQp1BIKJdaT59P8hmABW2cudGE4j/view?usp=sharing",
      "_blank",
    );
  };
      ...
      <div className="flex flex-col xl:flex-row items-center justify-between pt-6 xl:pt-6 xl:pb-24">
        ...
        <div className="text-center xl:text-left order-2 xl:order-none">
          ...
          <p className="max-w-[500px] mb-9 text-white/80 mt-4">
            I'm a full-stack developer with market experience, focused on
            building beautiful and user-friendly websites and applications.
          </p>
