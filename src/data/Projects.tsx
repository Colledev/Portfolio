...
export const projectsFullStack: Project[] = [
  ...
  {
    title: "Eletrocolle",
    image: "/Projects/Eletrocolle.png",
    description:
      "Institutional and e-commerce website focused on electrical products and digital presence.",
    technologies:
      "Frontend: React, TypeScript, TailwindCSS \n\n Deploy/Infra: Vercel, Domain and SEO optimization",
    moreInfo:
      "Implemented Features\n\nResponsive Website: Optimized user experience for desktop and mobile devices.\nProduct Showcase: Structured catalog and business information pages.\nPerformance and SEO: Improved loading speed and search visibility.",
    repository: "https://eletrocolle.com/",
    status: "Completed",
    site: "https://eletrocolle.com/",
  },
];
...
export const projectsBackend: Project[] = [
  {
    ...
    moreInfo:
      "Implemented Features\n\nJWT Authentication: Implementation of JWT-based authentication with endpoints for user registration, login, and profile update.\n Multi-Factor Authentication using speakeasy and qrcode for better security of authentication.",
    repository: "https://github.com/Colledev/user-auth-mfa",
    status: "Completed",
  },
  {
